...
def get_text_mesage(message):
    if message.text == '/oder':
        ...
        bot.send_message(message.from_user.id, 'Пожалуйста, оставьте свой номер телефона, чтобы мастер смог с вами связаться, узнать о проблеме и назначить удобное время врстечи')
